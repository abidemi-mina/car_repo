...
def contact(request):
    if request.method =="POST":
        ...
        print('First_name:',first_name, 'Last_name:', last_name, 'Email_address:', email_address)
        ...
        html_message = render_to_string('Cars/mail-template.html', args)
        plain_message = strip_tags(html_message)
        from_email = settings.EMAIL_FROM
        send = mail.send_mail(subject, plain_message, from_email, ['alayandesteven@gmail.com', ], html_message=html_message)
        if send:
