...
def contact(request):
    if request.method =="POST":
        ...
        print('Full_name:',full_name, 'Email_address:', email_address, 'Message:', message )
        ...
        from_email =' <alayandesteven@gmail.com>'
        send = mail.send_mail(subject, plain_message, from_email, ['alayandesteven@gmail.com', 'oalayande722@gmail.com'], html_message=html_message, fail_silently=True)
        if send:
