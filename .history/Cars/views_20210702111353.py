...
def blog_detail(request,blog_id):
    blogdetail = Blog.objects.order_by(id=blog_id)
    single_post = get_object_or_404(Blog, id=blog_id)
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            comment.save()
            return redirect('Cars:blog_detail', id=single_post.id)
        single_post = {'form': form, 'post': blogdetail,}
