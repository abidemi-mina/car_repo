...
def blog_detail(request, blog_id,slug):
    ...
    blg = get_object_or_404(Blog, slug = slug)
    ...
    return render(request, 'htmls/blog-details.html', {'post':blogdetail, 'comments':comments, 'new_comment':new_comment, 'comment_form':comment_form})
